...
//
//     final timeObject = timeObjectFromJson(jsonString);

import 'dart:convert';

TimeObject timeObjectFromJson(String str) => TimeObject.fromJson(json.decode(str));

String timeObjectToJson(TimeObject data) => json.encode(data.toJson());
